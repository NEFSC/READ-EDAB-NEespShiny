...
cat(badger::badge_devel("NOAA-EDAB/NEespShiny", "blue"),
    badger::badge_last_commit("NOAA-EDAB/NEespShiny"),
    badger::badge_custom("repo size", paste(total_size, "MB"), color = "blue", url = "https://github.com/NOAA-EDAB/NEespShiny"),
    sep = "\n")
```
